...
public List<MessageResponseDto> getConversation(Long userId1, Long userId2) {
    ...
    // 2. Récupération des messages (on passe les IDs dans les deux sens)
